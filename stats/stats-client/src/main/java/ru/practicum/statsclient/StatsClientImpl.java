...
public class StatsClientImpl implements StatsClient {
    ...
    public List<Stat> getStat(LocalDateTime start, LocalDateTime end, List<Long> eventIds, boolean unique) {
        ...
        log.info("Sent a request for statistics eventIds = {}", eventIds);
    ...
    private void saveHit(HitDto dto) {
        Unirest.post(uri + "/hit")
                ...
                .asEmpty();
        log.info("Request has been sent to save the request ip = {} by url = {}", dto.getIp(), dto.getUri());
    }
    ...
    private void saveHit(HitsDto dto) {
        Unirest.post(uri + "/hits")
                ...
                .contentType("application/json")
                .asEmpty();
        log.info("Request has been sent to save the request ip = {} by urls = {}", dto.getIp(), dto.getUris());
    }
